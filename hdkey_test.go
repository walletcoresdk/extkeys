...
func TestMaxDepth(t *testing.T) {
	...
	password := ""
	seed := mnemonic.MnemonicSeed(phrase, password)

	fmt.Printf("%x\n", seed)
	lastParentKey, err := NewMaster(seed)
	if err != nil {
...
// 	seed = mnemonic.MnemonicSeed("daring cement mixed distance strategy priority birth solid badge multiply judge maximum", "")
...
// 	fmt.Println("BIP32 Root Key", rootKey)

// 	key, err := rootKey.BIP44Child(0, 0)
// 	if err != nil {
// 		t.Errorf("Error deriving BIP44-compliant key: %s", err)

// 	}

// 	decoded := base58.Encode(key.ToECDSABTC().Serialize())
// 	fmt.Println("base58 Encode Private Key:", decoded)
// 	fmt.Println("base58 CheckEncode Private Key:", base58.CheckEncode(key.ToECDSABTC().Serialize(), MainnetVersion))

// 	wif, err := NewWIF(key.ToECDSABTC(), true)
// 	if err != nil {
// 		t.Errorf("Error NewWIF: %s", err)
// 	}
// 	fmt.Println("base58 wif Private Key:", wif.String())

// 	// JAG13A9ufYM4CeqYBuJDUGD1pfjaUaRxpEKrj8D9a7ha
// 	// L5mKYns2pBisdC8XY8v9TrLEiTsGLBN1XLHAttk24FLuZK7EULte
// 	// 5KkaCjZdfLCJMtTdNZ9sQJXBp1CPWGVKhQQ9axgCZue8qBzrjzw
// 	//
// 	// xprvA2dEyy7tFqB98LYP9DbGikatLmbHdBnRPjv2QLAqfrAhhQFEbBE6BLxDGvnck9MuAoYmgbiqcEWJQdDyDkoT2KWY7iXks9vRSErEYjRb4nC

// 	privateKeyECDSA := key.ToECDSA()

// 	fmt.Println("Extended Private Key:", key.String())

// 	privKeyBytes := crypto.FromECDSA(privateKeyECDSA)
// 	privKey := fmt.Sprintf("0x%x", privKeyBytes)
// 	fmt.Println("Private Key:", privKey)

// 	// 非压缩公钥
// 	// 0x04 || x || y
// 	// 65 字节
// 	// 前缀：1 字节 (0x04，表示非压缩形式)
// 	//
// 	// 		完整 𝑥,𝑦
// 	// 		x,y	常用于计算与签名验证
// 	pubKeyUncompressed := crypto.FromECDSAPub(&privateKeyECDSA.PublicKey)
// 	fmt.Printf("Uncompressed Public Key: 0x%x\n", pubKeyUncompressed)
...
// 	// x 和 y 的符号位
// 	// 常用于存储与传输
// 	pubKeyCompress := fmt.Sprintf("0x%x", (crypto.CompressPubkey(&privateKeyECDSA.PublicKey)))
// 	fmt.Println("Compress Public Key:", pubKeyCompress)

// 	// 0x044466e929fc75a0011a608f1375fa26f077b5fbd3cfd3181008ae53c347921ed5103162e8d318a865d99e3f9ef512f0562a3ee624f8b2408aa36ab059d421ba90
// 	// 0x024466e929fc75a0011a608f1375fa26f077b5fbd3cfd3181008ae53c347921ed5

// 	address := crypto.PubkeyToAddress(privateKeyECDSA.PublicKey).Hex()
// 	fmt.Println("m/44'/60'/0'/0/0 address: ", address)

// 	// 0x034a060cc4be4133825cdbd305d10676464c8617b66c06f7f930ea3ce728d0934e
// 	// 044d4a846a905c88a0e65b8b835b135cec0bb94f31052792cd09c3f7c40db65e8c2f4a39c08b2e80b936cd4ec049c0682118a76bd6e7921ca98dede43efe85c89c
